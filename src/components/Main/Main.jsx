...
const Main = () => {
  ...
  const { tasks, loading, error, getTasksByStatus, createTask } = useTasks();
  ...
  const handleCardClick = (card) => {
    ...
    console.log("ID карточки:", card.id, "тип:", typeof card.id);
    console.log("_ID карточки:", card._id, "тип:", typeof card._id);
